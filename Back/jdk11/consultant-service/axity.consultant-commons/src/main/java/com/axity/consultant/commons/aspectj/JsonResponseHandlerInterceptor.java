package com.axity.consultant.commons.aspectj;
...
import com.axity.consultant.commons.exception.ValidationException;
import com.axity.consultant.commons.response.GenericResponseDto;
import com.axity.consultant.commons.response.HeaderDto;
...
public class JsonResponseHandlerInterceptor implements HandlerInterceptor
{
   ...
   * 
   */
  @Around("execution (* com.axity.consultant.controller.*.*(..))"
      + " and @annotation(com.axity.consultant.commons.aspectj.JsonResponseInterceptor)")
