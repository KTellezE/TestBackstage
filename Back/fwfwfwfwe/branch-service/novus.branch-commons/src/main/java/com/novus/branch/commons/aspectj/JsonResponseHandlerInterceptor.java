...
import com.novus.branch.commons.response.HeaderDto;
...
public class JsonResponseHandlerInterceptor implements HandlerInterceptor
{
   ...
   * 
   */
  @Around("execution (* com.novus.branch.controller.*.*(..))"
      + " and @annotation(com.novus.branch.commons.aspectj.JsonResponseInterceptor)")
